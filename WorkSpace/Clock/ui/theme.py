...
miFont = getAppFont(22, 'ARLRDBD') # pygame.font.Font(fontPath, 26)
miniFont = getAppFont(19, 'ARLRDBD') # pygame.font.Font(fontPath, 26)
tinyFont = getAppFont(17, 'ARLRDBD') # pygame.font.Font(fontPath, 24)
